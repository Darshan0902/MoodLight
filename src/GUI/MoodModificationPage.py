...
class MoodModificationPage(CTk):
    ...
    def __init__(self, master):
        ...
        self.mood_label_4 = CTkLabel(self.mood_modif_frame, text="How would you rate your mood today ?", font=CTkFont(family="Comic Sans MS", size=30, weight="bold"), text_color="white")
